    ...
    dcc.Tabs(id="tabs", value='tab-meas', children=[
        ...
        dcc.Tab(label='2. Создание фазовой функции', value='tab-phase', children=[
          html.Div([
            ...
            html.P('Для частиц агломератов доступны следующие значения действительной и мнимой части показателя преломления. m_re = (1.35, 1.40, 1.45, 1.50, 1.55, 1.60), m_im = (0.0, 0.005, 0.010, 0.015, 0.020, 0.025, 0.030). Указание произвольного значения показателя преломления вернет ближайшее из значений.'),
            html.Table([
              html.Tr([
                html.Td([
